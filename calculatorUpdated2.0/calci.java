...
public class calci extends javax.swing.JFrame {
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        // TODO add your handling code here:
             ...
             double result = calcuate(Sb.toString());
         jTextField1.setText(calcuate(Sb.toString())+"");
         Sb.setLength(0);
         Sb.append(result);
...
// my calcii
     public static int calcuate(String Expression) {
        ...
        char[] symbolArr=new char[15];
        Arrays.fill(symbolArr,'z');
...
//        }
        ...
        for(int i=0;i< Expression.length();i++){
           if(Expression.charAt(i)=='+'||Expression.charAt(i)=='/'||Expression.charAt(i)=='*'||Expression.charAt(i)=='-'){
               symbolArr[count]=Expression.charAt(i);
               count++;
           }
        }
        ...
        for (int i = 0; i < symbolArr.length && symbolArr[i] != 'z'; i++) {
            if (symbolArr[i] == '*' || symbolArr[i] == '/') {
                numbers[i] = symbolArr[i] == '*'
                ...
                for (int j = i; j < symbolArr.length - 1; j++) {
                    symbolArr[j] = symbolArr[j + 1];
                }
                i--; 
            }
        }
...
//            if(symbolArr[i]!='z') {
//                System.out.println(symbolArr[i]);
//            }
//        }
